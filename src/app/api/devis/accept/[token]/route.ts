        ...
        await sendEmail({
          ...
          html: `
            <div style="font-family:'Helvetica Neue',Arial,sans-serif;max-width:600px;margin:0 auto;padding:32px 24px;color:#18181b">
              ...
              <div style="text-align:center;margin-bottom:32px">
                <a href="${process.env.NEXT_PUBLIC_APP_URL || 'https://stravon.fr'}/devis/${devis.id}" style="display:inline-block;padding:12px 32px;background:${brandColor};color:white;text-decoration:none;border-radius:10px;font-size:14px;font-weight:600">
                  Voir le devis
                </a>
              </div>
